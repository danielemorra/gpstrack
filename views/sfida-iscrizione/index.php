...
//	            'template' => "{label}\n<div class=\"col-lg-3\">{input}</div>\n<div class=\"col-lg-8\">{error}</div>",
        ...
        <div style="background-color: #9d9d9d; padding: 8px; margin-top: 8px; margin-bottom: 8px;">
                ...
                Visualizza <?= $form->field($sfidaIscrizModel, 'statoSfida')->dropDownList(
...
//                    ['prompt'=>'Select Option']
                ...
                <div class="form-group">
                    <div class="col-lg-offset-1 col-lg-11">
                        <?= Html::submitButton('Aggiorna', ['class' => 'btn btn-primary', 'name' => 'update-sfide-button']) ?>
                    </div>
                </div>
        </div>
